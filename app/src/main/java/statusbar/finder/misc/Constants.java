...
public class Constants {
    ...
    public static final String PREFERENCE_KEY_LYRICS_CONFIGURATION = "lyrics_configuration";
    ...
    public static final String BROADCAST_LYRICS_DELETE_RESULT_REQUEST = String.format("%s.LYRICS_DELETE_RESULT_REQUEST", BuildConfig.APPLICATION_ID);
    public static final String BROADCAST_LYRICS_UPDATE_ALIAS_REQUEST = String.format("%s.LYRICS_UPDATE_ALIAS_REQUEST", BuildConfig.APPLICATION_ID);
}
